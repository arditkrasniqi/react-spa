                                            ...
                                            <Thumbnail src={this.state.user.avatar_url} alt="242x200">
                                                ...
                                                <Row className="text-left">
                                                    <Col xs={12}>
                                                        ...
                                                        <p><strong>Blog</strong>: <a target="_blank" href={this.state.user.blog}>{this.state.user.blog}</a></p>
                                                        <p><strong>Email</strong>: {this.state.user.email}</p>
                                                        <p><strong>Github URL</strong>: <a target="_blank" href={this.state.user.html_url}>{this.state.user.html_url}</a></p>
                                                    </Col>
                                                </Row>
                                            </Thumbnail>
                                        </Col>
